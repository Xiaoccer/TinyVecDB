curl -X POST -d '{"vector": [0.8], "id":10, "index_type":1}' http://localhost:7123/VdbService/http/upsert
curl -X POST -d '{"vector": [0.5], "k":2, "index_type":1}' http://localhost:7123/VdbService/http/search
curl -X POST -d '{"id":10}' http://localhost:7123/VdbService/http/query
curl -X POST -d '{"vector": [0.3], "id":10, "index_type":1}' http://localhost:7123/VdbService/http/upsert

curl -X POST -d '{"vector": [0.8], "id":9, "index_type":2}' http://localhost:7123/VdbService/http/insert
curl -X POST -d '{"vector": [0.5], "k":2, "index_type":2}' http://localhost:7123/VdbService/http/search
